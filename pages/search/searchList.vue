    ...
    export default {
        ...
        methods: {
            findHouseList() {
                ...
                // 如果有搜索关键词，进行过滤
                let filteredData = this.keyword ? 
                    mockData.filter(item => 
                        item.villageName.includes(this.keyword) || 
                        (item.introduce && item.introduce.includes(this.keyword))
                    ) : mockData;
